...
3. **Tech Lead** reviews each PR with mandatory evidence tables and gated verification — merges on approval, creates issues and spawns fix agents on rejection
